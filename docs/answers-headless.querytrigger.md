...
[Home](./index.md) &gt; [@yext/answers-headless](./answers-headless.md) &gt; [QueryTrigger](./answers-headless.querytrigger.md)
...
|  Suggest | <code>&quot;suggest&quot;</code> | Indicates that the query was suggested by a [SpellCheck](./answers-headless.spellcheck.md) response. |
