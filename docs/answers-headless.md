...
|  [createDateRangeFilter(fieldId, range)](./answers-headless.createdaterangefilter.md) | Creates a [Filter](./answers-headless.filter.md) or [CombinedFilter](./answers-headless.combinedfilter.md) that matches all results where the given field value falls in a specific Date [Range\_2](./answers-headless.range_2.md)<!-- -->. |
...
|  [createNumberRangeFilter(fieldId, range)](./answers-headless.createnumberrangefilter.md) | Creates a [Filter](./answers-headless.filter.md) or [CombinedFilter](./answers-headless.combinedfilter.md) that matches all results where the given field value falls in a specific number [Range\_2](./answers-headless.range_2.md)<!-- -->. |
...
|  [provideCore(config)](./answers-headless.providecore.md) | The entrypoint to the answers-core library. |
...
|  [Range\_2](./answers-headless.range_2.md) | An interface representing a range of values of type T. |
|  [RangeBoundary](./answers-headless.rangeboundary.md) | A boundary for a [Range\_2](./answers-headless.range_2.md) of type T. |
