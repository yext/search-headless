...
[fieldType](./search-headless.facebookurldirectanswer.fieldtype.md)
...
[EnumOrLiteral](./search-headless.enumorliteral.md)<!-- -->&lt;[BuiltInFieldType.FacebookURL](./search-headless.builtinfieldtype.md)<!-- -->&gt;
