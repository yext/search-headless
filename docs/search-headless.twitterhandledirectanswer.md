...
[fieldType](./search-headless.twitterhandledirectanswer.fieldtype.md)
...
[EnumOrLiteral](./search-headless.enumorliteral.md)<!-- -->&lt;[BuiltInFieldType.TwitterHandle](./search-headless.builtinfieldtype.md)<!-- -->&gt;
